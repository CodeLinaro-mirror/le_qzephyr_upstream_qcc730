...
- OPENOCD_PATH: Path to the installation directory with OpenOCD binary that supports CH347
- (alteratively) JLINK_PATH: Path to the J-Link GDB server installation directory
